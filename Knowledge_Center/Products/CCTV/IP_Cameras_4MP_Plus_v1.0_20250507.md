...
| ColorVu/color night vision issues | Light or settings problems | 1. Verify supplemental light is functioning properly<br>2. Check for obstructions blocking the light<br>3. Ensure color night vision feature is enabled<br>4. For extreme darkness, consider adding auxiliary lighting<br>5. Update firmware to latest version for improved performance |
...
| AI detection not working properly | Configuration or firmware issues | 1. Verify AI detection features are enabled<br>2. Update to the latest firmware version<br>3. Adjust detection sensitivity if available<br>4. Ensure camera has proper view of detection area<br>5. Reset to factory defaults if problem persists |
